# identigon.github.io — Backlog

Flat list, not phased — this is a content site, not a versioned library. See `docs/adr/` for
decisions already made and why.

## Outstanding

- [ ] Generated reference docs (Javadoc for `alterego`/`incognito`) published from
  `identigon/identigon`'s own CI and linked in from here, once that exists (see ADR 0001) — not
